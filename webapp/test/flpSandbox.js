			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"QotaManager-display": {
								"semanticObject": "QotaManager",
								"action": "display",
								"description": "Qota Manager",
								"title": "Qota Manager",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exed.com.qotamanager",
									"url": sap.ui.require.toUrl("exed/com/qotamanager")
								}
							}
						}
					}
